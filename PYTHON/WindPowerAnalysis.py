import math
contatore=0
infile= open('Datawindwavetab_Tahiti.csv','r')
...
for d in range(0,len(data)):
    Flag=True
    apprx=round(data[d]['wind speed'],0)                        #inserisco il cp giusto per ogni velocità del vento
...
with open(os.path.join(output_dir, 'San_Pietro_power_data15MWh.csv'), 'w', newline='') as outfile:
